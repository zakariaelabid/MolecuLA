...
This folder contains compact recovered results for the autoregressive VAE study. The AR checkpoint is included under `checkpoints/`, and these files preserve selected compact outputs from executed notebook results and legacy traversal image folders.
...
To reproduce the AR workflow from scratch, run the study notebooks in the order described in the top-level README.
